function varargout = estimate_mod_hist(Mdl, YData, varargin)
...
%
  ...
  try
    ...
    Extra.FitInformation.StandardErrors.SAR=num2cell(zeros(1,LagsSAR(end)));
    Extra.FitInformation.StandardErrors.SAR(LagsSAR)=num2cell(SE(iSAR));
    ...
    Extra.LagOpLHS{1,1}.Dimension=1;

    Extra.LagOpLHS{1,2}.Lags=[0 LagsSAR];
    Extra.LagOpLHS{1,2}.Degree=LagsSAR(end);
    Extra.LagOpLHS{1,2}.Dimension=1;

    Extra.LagOpRHS{1,1}.Lags=[0 LagsMA];
    Extra.LagOpRHS{1,1}.Degree=LagsMA(end);
    Extra.LagOpRHS{1,1}.Dimension=1;

    Extra.LagOpRHS{1,2}.Lags=0;
    Extra.LagOpRHS{1,2}.Degree=0;
    Extra.LagOpRHS{1,2}.Dimension=1;
  catch old
