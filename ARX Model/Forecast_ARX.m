...
% The following code simulates the in-sample ARX model fit against the candidate signal
...
load Results_ARX.mat % Load optimal ARX model of the candidate signal
...
% Simulate individual ARX model forecasts
...
save('Forecast_ARX.mat','power_err','hist_err','pear_corr');

saveas(f1,'InSampleFit_ARX.fig');
saveas(f1,'InSampleFit_ARX.svg');
saveas(f1,'InSampleFit_ARX.eps');

saveas(f2,'PowerSpec_ARX.fig');
saveas(f2,'PowerSpec_ARX.svg');
saveas(f2,'PowerSpec_ARX.eps');

saveas(f3,'Hist_ARX.fig');
saveas(f3,'Hist_ARX.svg');
saveas(f3,'Hist_ARX.eps');
